@extends('layout.base')
@section('content')
    <div class="w-full max-w-screen h-full relative overflow-x-hidden flex min-h-screen" id="login">
        <div class="flex w-full flex-col justify-center items-center gap-5 bg-black/50 backdrop-blur-md">
            <div
                class="bg-black/20 w-[50%] p-5 flex flex-col items-center justify-center gap-5 rounded-xl border-2 border-blue-500">
                <div
                    class="flex justify-between items-center gap-5 bg-blue-500 rounded-b-[50%] p-2 w-full h-20 -translate-y-8">
                ...
                <div class="flex flex-col w-[90%] gap-5 items-start justify-center p-5 bg-blue-950/50 rounded-lg relative">
                    ...
                    <form data-url="{{ route('process-login') }}" method="post" id="loginForm"
                        ...
                        @csrf
                        <div class="flex gap-3 items-start justify-start w-full rounded-lg p-3 border border-gray-700">
                        ...
                        <div class="w-full bg-blue-500/20 flex items-center justify-center p-2 rounded-lg mt-5 gap-5">
