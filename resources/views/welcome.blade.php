                ...
                <div class="flex flex-col w-full items-center justify-evenly showing" id="coreSubjectsContainer">
                    ...
                    <div
                        ...
                        <form
                            ...
                            id="coreResults" method="POST" data-url="{{ route('process-core') }}"
                            action="{{ route('process-core') }}">
                            @csrf
                            <div
                ...
                <div class="flex flex-col w-full items-center justify-evenly hide" id="electiveSubjectsContainer">
                    ...
                    <div
                        ...
                        <form id="electiveResults"
                            ...
                            method="post" data-url="{{ route('process-electives') }}"
                            action="{{ route('process-electives') }}">
                            @csrf
                        ...
                        <div class="flex text-white rounded-3xl w-full justify-between gap-10 bg-neutral-950 p-1">
